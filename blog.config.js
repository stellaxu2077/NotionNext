...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Stella', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'A cat person', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-eight-chi-66.vercel.app/', // 网站地址
